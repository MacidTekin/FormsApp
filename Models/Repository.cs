namespace FormsApp.Models
{
    public class Repository
    {
        ...
        public static void EditProduct(Product updatedProduct)//updatedProduct güncellenmiş formdan gelen model bilgisi olacak.
        {
            ...
            if(entity != null)
            {
                ...
                entity.CategoryId = updatedProduct.CategoryId; //bunları yaptıktan sonra EditProduct ı çağırmamız lazım
                entity.IsActive = updatedProduct.IsActive;

            }
        }

        public static void EditIsActive(Product updatedProduct)//updatedProduct güncellenmiş formdan gelen model bilgisi olacak.
        {
            var entity = _products.FirstOrDefault(p=>p.ProductId == updatedProduct.ProductId);
            if(entity != null)
            {
